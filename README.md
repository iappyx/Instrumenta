...
- If on Mac, to enabel export to e-mail, also download this AppleScript (https://github.com/iappyx/Instrumenta/raw/main/InstrumentaAppleScriptPlugin.applescript) and copy it to ~/Library/Application Scripts/com.microsoft.Powerpoint/  
