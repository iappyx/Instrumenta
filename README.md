...
| Export | - E-mail selected slides (as PDF or PPT) *not supported on Mac*<br>- Copy storyline to clipboard<br>- Export storyline to Word *not supported on Mac*<br>- Paste storyline in shape<br>- Copy slide notes to clipboard<br>- Export slide notes to Word *not supported on Mac*|
...
* Mail merge from Excel-file is not yet supported due to OS X sandbox.
