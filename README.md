...
| Export | - E-mail selected slides (as PDF or PPT) *not supported on Mac*|
| Storyline | - Copy storyline to clipboard<br>- Export storyline to Word *not supported on Mac*<br>- Paste storyline in shape<br>- Copy slide notes to clipboard<br>- Export slide notes to Word *not supported on Mac*|
...
* Convert slides to pictures (readonly) does not (yet) work
