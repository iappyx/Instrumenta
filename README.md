...
- Download the add-in file in the latest release (https://github.com/iappyx/Instrumenta/releases/download/1.04/InstrumentaPowerpointToolbar.ppam) or the latest beta (https://github.com/iappyx/Instrumenta/raw/main/bin/InstrumentaPowerpointToolbar.ppam) and save it in a fixed location
...
- Download the AppleScript file (https://github.com/iappyx/Instrumenta/releases/download/1.04/InstrumentaAppleScriptPlugin.applescript) 
